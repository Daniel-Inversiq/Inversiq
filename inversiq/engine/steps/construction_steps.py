...
from app.services.tenant_pricing import apply_construction_tenant_pricing_overrides
...
from app.verticals.construction.pricing_engine_us import (
    run_pricing_engine,
    load_rules_default,
)
...
def step_pricing_v1(state: PipelineState, step: StepConfig, assets: dict) -> StepResult:
    ...
    # dict.  Wrap in a SimpleNamespace so apply_construction_tenant_pricing_overrides
    ...
    effective_rules = apply_construction_tenant_pricing_overrides(base_rules, _tenant_like)

...
revision = "2026_04_18_01"
down_revision = "2026_04_17_03"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    table_name = "proposed_change_apply_intents"
...
def downgrade() -> None:
    ...
    op.drop_index("ix_pcai_created_at", table_name=table_name)
    op.drop_index("ix_pcai_status", table_name=table_name)
    op.drop_index("ix_pcai_change_id", table_name=table_name)
    op.drop_index("ix_pcai_tenant_id", table_name=table_name)

...
_ENGINE_PATCH = "app.verticals.painting.quote_service.compute_quote_for_lead_v15"
_ML_PATCH     = "app.verticals.painting.quote_service.capture_ml_data"

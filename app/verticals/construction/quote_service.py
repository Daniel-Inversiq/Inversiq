"""
app/verticals/construction/quote_service.py
...
compute_and_persist_quote(db, lead, *, vertical_id)
    Called by ConstructionAdapter.compute_quote() after HTTP-layer validation.
...
from inversiq.engine.steps import register_all as _register_construction_steps

# app/verticals/construction/render_estimate.py
...
from app.verticals.construction.assumptions import PAINTLY_SCOPE_ASSUMPTIONS
from app.verticals.construction.copy import PAINTLY_ESTIMATE_COPY, fmt_qty
from app.verticals.construction.disclaimer import PAINTLY_ESTIMATE_DISCLAIMER
from app.verticals.construction.locale_eu import fmt_eur
from app.verticals.construction.needs_review import PAINTLY_NEEDS_REVIEW_COPY
...
def render_estimate_html_v2(
    *,
    ...
    try:
        from app.verticals.construction.router_app import logger as paintly_logger  # type: ignore
    except Exception:
        paintly_logger = None

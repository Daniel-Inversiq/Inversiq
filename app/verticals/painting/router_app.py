...
from app.verticals.painting.email_render import render_estimate_ready_email
...
def app_lead_approve(
    ...
    if (getattr(lead, "vertical", None) or "paintly") == "paintly":
...
def send_estimate(
    ...
    if is_htmx:
        from app.verticals.painting.router_htmx import render_quote_oob_response
